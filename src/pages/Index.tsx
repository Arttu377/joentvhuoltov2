            ...
            <div>
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center">
                  ...
                  <a href="tel:0500724515" className="text-gray-600 hover:text-[#2B4565] transition-colors">0500 724 515</a>
                </div>
                ...
                <div className="flex items-center">
                  ...
                  <a href="mailto:jari.simanainen@joenlaitehuolto.fi" className="text-gray-600 hover:text-[#2B4565] transition-colors">jari.simanainen@joenlaitehuolto.fi</a>
                </div>
              </div>
            </div>
          </div>
